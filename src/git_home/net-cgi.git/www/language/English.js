...
passphrase_short8="Insufficient password length. It should be a minimum of eight characters long."
...
bh_orbi_nowan_msg="Make sure that the cable is securely plugged into both the boradband modem port and the router Internet port."
